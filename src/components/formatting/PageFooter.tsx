...
export const Footer = () => {
  ...
  return (
    <footer className="py-12 px-4 w-full flex flex-col items-center">
      {/* Logos */}
      ...
      <p className="text-center mt-4">
        <Link href="https://psauiuc.org/" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:underline">
