...
const FAQ_DOC_URL =
  "https://docs.google.com/document/d/1Sd0w6Wma6ewMWcpAs7uy6IFmyLEwnDnjnLnzZG53Lpg/edit?usp=sharing";
...
function FAQLink({
  ...
  return (
    <Link
      ...
      className="underline font-bold text-highlight-2-primary"
    >
      {text}
    </Link>
  );
  ...
  return (
    <PageContainer title="FAQ">
      ...
      <div className="flex flex-row justify-evenly flex-wrap items-start">
        <div className="text-3xl sm:text-4xl lg:text-5xl font-bold w-full text-center my-8">
          General
        </div>
        <div className="flex flex-col w-11/12 lg:w-2/5">
          <FAQSection question="What is FACT?">
            FACT stands for Filipinx Americans Coming Together and is a
            conference hosted annually by the Philippine Student Association at
            the University of Illinois at Urbana-Champaign. It is the largest
            ...
            Filipinx culture, identity and issues. Despite the conference’s
            title, the conference is not limited to delegates of Filipinx
            descent. The facilitators and delegates come from different
            backgrounds and ethnicities, and the workshops cover a wide array of
            topics. FACT’s mission is to build a community of leaders by
            uniting, enlightening and empowering the
            Filipinx/Fil-Am/Non-Filipinx youth nationwide. By exploring our
          ...
          <FAQSection question="I am a minor, can I go to FACT?">
            Due to university policies and safety reasons, minors who are
            unattended by their guardians are not permitted to attend FACT
            affiliated events.
          </FAQSection>

          <FAQSection question="What are COVID/illness restrictions?">
            PSA is currently not requiring any masking or vaccination for this
            year’s FACT. If you are feeling sick or unwell, please refrain from
        ...
        <div className="flex flex-col w-11/12 lg:w-2/5">
          <FAQSection question="Is there a dress code?">
            ...
            weather. Most delegates wear their organization’s merchandise to
            conference.
          </FAQSection>
          <FAQSection question="Will any part of the conference be on Zoom/virtual?">
            This year, FACT will be a purely in-person conference. However, we
            will be providing informational materials on our Instagram,
            newsletter, and website after the conference for anyone hoping to
            stay connected to the speakers, guests, and performers post-FACT.
          </FAQSection>
        ...
        <div className="flex flex-row justify-evenly gap-x-20 flex-wrap lg:w-11/12 px-8 lg:px-4">
          <div className="text-3xl sm:text-4xl lg:text-5xl font-bold text-center my-8 w-full">
            At UIUC
          </div>
          <div className="flex flex-col lg:w-2/5">
            <FAQSection question="How do I book a hotel using the hotel block booking system?">
              FACT has coordinated a selection of hotel blocks specifically for
              conference guests. Details and instructions are outlined on our
              Instagram (
              <FAQLink
                href="http://instagram.com/psa_fact"
                text="@psa_fact"
                newTab={true}
              />
              ) and our newsletter, but rooms are only available for booking for
              a limited time. It is highly encouraged that you book in advance
              as this year’s FACT coincides with a football game.
            </FAQSection>
            <FAQSection question="Where can I eat?">
              During your free time during the FACT Conference, you have the
              freedom to choose between the variety of food options available on
              and near the UIUC campus. We encourage you to support our day-of
              food and drink fundraisers, which will be announced via our
              Instagram (
              <FAQLink
                href="http://instagram.com/psa_fact"
                text="@psa_fact"
            ...
            <FAQSection question="How can I get around campus?">
              All MTD bus stops within campus borders will be marked by an
              orange bus stop sign and are free of charge. Outside campus, the
              white bus stop sign will indicate that a fee must be paid unless
              waivered by a UIUC identification card.
            </FAQSection>
          </div>
          <div className="flex flex-col lg:w-2/5">
            <FAQSection question="Parking Policies">
              Parking for non-UIUC faculty and staff is metered and/or limited
              to the spaces outlined{" "}
              <FAQLink
                href="https://parking.web.illinois.edu/maps/campus-parking-map"
                text="on this website"
                newTab={true}
              />
              . Meter payments may be processed by coin, Pay by Phone, or
              CashKey depending on the outlined instructions. Free weekend and
              overnight parking lots are listed{" "}
              <FAQLink
                href="https://parking.web.illinois.edu/campus-parking/weekday-and-overnight"
                text="on this website"
                newTab={true}
              />
              . Parking is strictly monitored by campus officials and those not
              adhering to the policies may be subject to ticketing or towing.
              FACT is not responsible for any parking charges made towards all
              attendees.
            </FAQSection>
            ...
            <FAQSection question="What do I do if I lose anything during the conference?">
              As outlined in the Terms and Conditions that all registered
              participants affirm to, all FACT attendees are responsible for
              “loss of items or damage to FACT Conference facilities” and are
              “liable for any costs incurred to repair any inflicted damage.”
            </FAQSection>
          </div>
        </div>
