    ...
    return (
        <>
            ...
            <div className="relative flex flex-col">
                ...
                <div className="w-full sm:w-4/5 min-h-screen h-fit flex justify-center sm:justify-start text-center flex-col md:flex-row md:text-left inset-x-0 mx-auto my-8 sm:px-20 gap-8">
