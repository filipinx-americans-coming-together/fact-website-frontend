      ...
      <BackgroundImage imageURL={BACKGROUND_URL}>
        ...
        <div className="max-w-lg flex justify-center text-center sm:flex-col-reverse md:flex-row md:text-left">
          <div className="flex flex-col justify-start">
            <div className="font-bold my-6 sm:text-4xl lg:text-6xl">MAGBUBUNGA</div>
            <div className="font-bold my-6 sm:text-4xl lg:text-6xl">Planting Prosperity</div>
            <div className="font-bold my-6 sm:text-4xl lg:text-6xl">FACT 2024</div>
            <div className="italic font-light my-2 mt-4">Philippine Student Association</div>
            <div className="italic font-light my-2">University of Illinois at Urbana-Champaign</div>
          </div>
